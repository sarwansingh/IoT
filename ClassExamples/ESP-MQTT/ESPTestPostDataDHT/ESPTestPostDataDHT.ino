...
int CELSIUS=0, HUM=0;
String Device_No="test1" , DST_IP="arshbir.com",username="demo1";  //demo1*123
void postData()
{  
...
//str="AT+CWJAP=\"demo\",\"12345678\"";Serial.println(str );   
  WiFi_check() ;
  if (wf == true){ 
    connectWifi();  
    postData();
