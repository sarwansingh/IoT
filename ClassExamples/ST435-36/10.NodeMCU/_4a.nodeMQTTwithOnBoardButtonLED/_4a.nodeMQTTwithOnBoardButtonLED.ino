...
const int ledPin = D1; //2;      // onboard LED pin
char ssid[]="VS" ,*pwd = "0987654321" ;
...
void setup() {
  ...
  client.setServer("iot.eclipse.org", 1883);  // connect to MQTT Server/broker
