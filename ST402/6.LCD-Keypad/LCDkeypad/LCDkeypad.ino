...
void loop() {
  ...
  if (digitalRead(C1) ==  LOW) {lcd.print("1"); buzzON();delay(300);buzzOFF();
    if  (digitalRead(C1) ==  LOW)lcd.print("A"); delay(300);
    if  (digitalRead(C1) ==  LOW)lcd.print("B"); delay(300);
  }
  if (digitalRead(C2) ==  LOW) {lcd.print("2"); buzzON();delay(300);buzzOFF();}
  if (digitalRead(C3) ==  LOW) {lcd.print("3"); buzzON();delay(300);buzzOFF();}
 //////////// second row
